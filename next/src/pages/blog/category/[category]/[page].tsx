...
export const getStaticPaths: GetStaticPaths = async () => {
    ...
    const paths = res.data.map((c) => ({
        params: { category: c.attributes.slug, page: '0' },
    }));
...
export const getStaticProps: GetStaticProps<{
    ...
    let categorySlug = params?.page ?? 'typescript';
    if (Array.isArray(categorySlug)) categorySlug = 'typescript';
